...
menuItem2 = MenuItem(user_id=1, name="Peking Duck",
                     description=""" A famous duck dish from Beijing[1]
                      ...
                      mostly the skin and little meat, sliced in front
...
menuItem1 = MenuItem(user_id=1, name="Pho",
                     description="""a Vietnamese noodle soup
                      consisting of broth, linguine-shaped rice
...
menuItem3 = MenuItem(user_id=1, name="Honey Boba Shaved Snow",
                     description="""Milk snow layered with honey boba,
                      jasmine tea jelly, grass jelly, caramel,
                       cream, and freshly made mochi", price="$4.50""",
...
menuItem1 = MenuItem(user_id=1, name="Lemon Curd Ice Cream Sandwich",
                     description="""Lemon Curd Ice Cream Sandwich on
                     a chocolate macaron with cardamom meringue and cashews""",
